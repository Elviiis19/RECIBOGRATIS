...
export const richSeoData: Record<string, RichSEOContent> = {
  ...
  simples: {
    ...
    useCasesConclusion:
      "Proteja o seu direito, afaste as chances de fraude, e formalize qualquer repasse em um documento validado, limpo e estruturado.",
    ...
    ctaText:
      "Produza sem qualquer burocracia um documento padronizado, dotado de formatação lícita e validade jurídica, pronto para arquivar, imprimir ou enviar diretamente no formato PDF.",
    exampleImageSrc: "/modelo-recibo-simples-preenchido.webp",
    exampleImageAlt:
      "Modelo do Recibo Simples Preenchido e Pronto para Imprimir",
